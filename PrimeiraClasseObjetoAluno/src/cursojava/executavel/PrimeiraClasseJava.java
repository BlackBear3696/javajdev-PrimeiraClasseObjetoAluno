...
public class PrimeiraClasseJava {
	...
	public static void main(String[] args) {
		...
		String RG=JOptionPane.showInputDialog("Número de RG do Aluno? ");
		String CPF=JOptionPane.showInputDialog("Número do CPF do Aluno? ");
		...
		String SerieM=JOptionPane.showInputDialog("Serie que o Aluno está matriculado?");
